...
Create the Fourth File
    ${file_path} =  Join Path  ${output_directory}  ${directory_3}  ${file_4}
    Create File  ${file_path}  Welcome to file four!!!
    Should Exist  ${file_path}
...
Move File 4 from Directory 3 to Directory 1
    ${source_path} =  Join Path  ${output_directory}  ${directory_3}  ${file_4}
    ${target_path} =  Join Path  ${output_directory}  ${directory_1}  ${file_4}
...
Copy File 1 from Directory 1 to Directory 3
    ${source_path} =  Join Path  ${output_directory}  ${directory_1}  ${file_1}
    ${target_path} =  Join Path  ${output_directory}  ${directory_3}  ${file_1}
